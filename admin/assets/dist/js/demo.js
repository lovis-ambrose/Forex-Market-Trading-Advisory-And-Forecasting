...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('Fleet:Management:MessageShowed')) < Date.now()) {
      localStorage.setItem('Fleet:Management:MessageShowed', (Date.now()) + (15 * 60 * 1000))
  ...
  $container.append(
    '<h5>Customize Fleet</h5><hr class="mb-2"/>'
  )
